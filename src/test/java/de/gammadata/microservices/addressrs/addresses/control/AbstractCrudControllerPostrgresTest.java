 ...
 * @param <Q>
 */
public abstract class AbstractCrudControllerPostrgresTest<T extends BaseEntity, Q extends SimpleQuerySpecification>
        extends AbstractEntityJpaPostgresTest {
